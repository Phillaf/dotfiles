# Generic hotkeys
# gsettings set org.gnome.desktop.wm.keybindings move-to-monitor-right "['<Shift><Alt>l', '<Control><Shift><Alt>Right']"
# gsettings set org.gnome.desktop.wm.keybindings move-to-monitor-left "['<Shift><Alt>h',  '<Control><Shift><Alt>Left']"
...
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-left "['<Primary><Alt>h', '<Control><Alt>Left']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-right "['<Primary><Alt>l', '<Control><Alt>Right']"
